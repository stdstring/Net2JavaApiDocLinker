...
{
    public static class ApiMemberUtils
    {
        /// <summary>
        ...
        private static ApiMember FindApiMember(string member, IList<ApiMember> apiMembers)
        {
        ...
        private static int CountApiMember(string member, IList<ApiMember> apiMembers)
        {
            int cnt = 0;
            foreach (ApiMember apiMember in apiMembers)
            {
